      ...
      <body className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans">
        <div className="bg-white max-w-md w-full p-8 rounded-3xl border border-slate-100 shadow-xl space-y-6 text-center">
          ...
          <div className="space-y-2">
            <h2 className="font-extrabold text-xl text-slate-900">Critical Application Error</h2>
            <p className="text-sm text-slate-500 leading-relaxed font-medium">
              A critical server-side error occurred in the page template. Please click below to reset.
            </p>
          </div>
          ...
          <button
            onClick={() => reset()}
            className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition-all cursor-pointer shadow-md"
          >
            Restart Application
          </button>
        </div>
